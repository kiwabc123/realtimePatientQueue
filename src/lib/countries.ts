...
const phoneCountryCodes: Record<string, string> = {
  ...
  GI: '+350', GR: '+30', GD: '+1-473', GT: '+502', GN: '+224', GW: '+245', GY: '+592', HT: '+509',
  ...
  NG: '+234', NO: '+47', OM: '+968', PK: '+92', PW: '+680', PS: '+970', PA: '+507', PG: '+675',
  PY: '+595', PE: '+51', PH: '+63', PL: '+48', PT: '+351', QA: '+974', RO: '+40', RU: '+7',
  RW: '+250', KN: '+1-869', LC: '+1-758', VC: '+1-784', WS: '+685', SM: '+378', ST: '+239',
  SA: '+966', SN: '+221', RS: '+381', SC: '+248', SL: '+232', SG: '+65', SK: '+421', SI: '+386',
  SB: '+677', SO: '+252', ZA: '+27', SS: '+211', ES: '+34', LK: '+94', SD: '+249', SR: '+597',
  SZ: '+268', SE: '+46', CH: '+41', SY: '+963', TW: '+886', TJ: '+992', TZ: '+255', TH: '+66',
  TL: '+670', TG: '+228', TO: '+676', TT: '+1-868', TN: '+216', TR: '+90', TM: '+993', TV: '+688',
...
export async function fetchCountries(): Promise<Country[]> {
  ...
  try {
    ...
    // Return empty array on error, form will still work with manual input
    return [];
  }
}
